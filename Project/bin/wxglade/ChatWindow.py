...
class ChatWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.html_chat_log = html2.WebView.New(self.panel_chat_window, wx.ID_ANY, style=wx.NO_BORDER,
    ...
    def OnScriptMessage(self, event):  # wxGlade: ChatWindow.<event_handler>
