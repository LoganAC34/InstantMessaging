...
class ChatWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_chat_window.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
        ...
        self.StatusConnected = wx.StaticText(self.panel_send, wx.ID_ANY, u"🔴")
        ...
        sizer_6.Add(self.StatusDevice, 1, wx.ALL | wx.EXPAND, 0)
        ...
        self.StatusCharacters = wx.StaticText(self.panel_send, wx.ID_ANY, "256/256 Characters")
        sizer_6.Add(self.StatusCharacters, 0, wx.EXPAND | wx.RIGHT, 3)
