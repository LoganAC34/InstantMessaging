...
class ChatWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_chat_log.Bind(wx.EVT_MOUSEWHEEL, self.MouseEvents, self.panel_chat_log)
        ...
        self.text_ctrl_message.Bind(wx.EVT_KEY_DOWN, self.OnKey_Press, self.text_ctrl_message)
        self.text_ctrl_message.Bind(wx.EVT_KEY_UP, self.OnKey_Release, self.text_ctrl_message)
