...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.html2.EVT_WEBVIEW_SCRIPT_MESSAGE_RECEIVED, self.OnScriptMessage, self.html_chat_log)
        self.Bind(wx.EVT_BUTTON, self.EasterEgg, self.button_easteregg)
        self.Bind(wx.EVT_BUTTON, self.OpenEmojis, self.emoji_keyboard)
