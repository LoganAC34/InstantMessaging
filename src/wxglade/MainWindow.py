...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        sizer_3.Add(self.Send, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 5)
        ...
        self.emoji_keyboard = wx.Button(self.panel_send, wx.ID_ANY, u"☻", style=wx.BORDER_NONE | wx.BU_EXACTFIT)
        ...
        self.emoji_keyboard.Enable(False)
        sizer_3.Add(self.emoji_keyboard, 0, wx.BOTTOM | wx.RIGHT | wx.TOP, 5)
