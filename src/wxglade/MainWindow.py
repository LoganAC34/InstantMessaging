...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_BUTTON, self.on_emoji_press, self.emoji_keyboard)
    ...
    def on_emoji_press(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'on_emoji_press' not implemented!")
        event.Skip()
