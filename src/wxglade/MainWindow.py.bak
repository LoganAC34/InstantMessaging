...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Tool Bar
        self.ChatWindow_toolbar = wx.ToolBar(self, -1, style=wx.TB_DEFAULT_STYLE | wx.TB_HORZ_TEXT | wx.TB_NODIVIDER | wx.TB_NOICONS)
        tool = self.ChatWindow_toolbar.AddTool(wx.ID_ANY, "Settings", wx.Bitmap(16, 16), wx.NullBitmap, wx.ITEM_NORMAL, "Opens Settings", "")
        self.Bind(wx.EVT_TOOL, self.OpenSettings, id=tool.GetId())
        tool = self.ChatWindow_toolbar.AddTool(wx.ID_ANY, "Clear Chat", wx.Bitmap(16, 16), wx.NullBitmap, wx.ITEM_NORMAL, "Clears Chat", "")
        self.Bind(wx.EVT_TOOL, self.ClearChat, id=tool.GetId())
        tool = self.ChatWindow_toolbar.AddTool(wx.ID_ANY, "Fortunes", wx.Bitmap(16, 16), wx.NullBitmap, wx.ITEM_NORMAL, "Hear your fortune!", "")
        ...
        self.html_chat_log = html2.WebView.New(self.panel_chat_window, wx.ID_ANY, style=wx.NO_BORDER, backend=wx.html2.WebViewBackendEdge)
        self.html_chat_log.SetBackgroundColour(wx.Colour(19, 19, 19))
        self.html_chat_log.AddScriptMessageHandler('wx_msg')
        ...
        self.html_chat_log.SetPage(GlobalVars.html_template_code, GlobalVars.path_resources)
        sizer_4.Add(self.html_chat_log, 1, wx.EXPAND, 0)
        ...
        self.text_ctrl_message = wxglade_ex.SpellCheckTextCtrl(self.panel_send, wx.ID_ANY, "", style=wx.TE_AUTO_URL | wx.TE_BESTWRAP | wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
        sizer_3.Add(self.text_ctrl_message, 1, wx.ALL | wx.EXPAND, 5)

        sizer_1 = wx.BoxSizer(wx.VERTICAL)
        sizer_3.Add(sizer_1, 0, wx.BOTTOM | wx.EXPAND | wx.RIGHT | wx.TOP, 5)

        self.emoji_keyboard = wx.Button(self.panel_send, wx.ID_ANY, u"☻", style=wx.BU_EXACTFIT | wx.BU_NOTEXT)
        self.emoji_keyboard.SetMinSize((30, 30))
        self.emoji_keyboard.SetFont(wx.Font(16, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        sizer_1.Add(self.emoji_keyboard, 0, 0, 5)

        sizer_1.Add((1, 1), 1, wx.EXPAND, 0)

        self.Send = wx.Button(self.panel_send, wx.ID_ANY, "Send", style=wx.BU_NOTEXT)
        self.Send.SetMinSize((30, 30))
        self.Send.SetBitmap(wx.Bitmap(os.path.join(GlobalVars.path_resources, 'send_icon.png')))
        sizer_1.Add(self.Send, 0, wx.TOP, 5)
        ...
        self.StatusConnected = wx.StaticText(sizer_6.GetStaticBox(), wx.ID_ANY, u"⬤ ", style=wx.ALIGN_LEFT)
        ...
        self.StatusDevice = wx.StaticText(sizer_6.GetStaticBox(), wx.ID_ANY, "CADD-88")
        sizer_6.Add(self.StatusDevice, 0, wx.EXPAND | wx.RIGHT, 4)

        sizer_6.Add((0, 0), 1, wx.EXPAND, 0)

        static_line_2 = wx.StaticLine(sizer_6.GetStaticBox(), wx.ID_ANY, style=wx.LI_VERTICAL)
        sizer_6.Add(static_line_2, 0, wx.EXPAND | wx.RIGHT, 4)

        self.StatusCharacters = wx.StaticText(sizer_6.GetStaticBox(), wx.ID_ANY, "0/256 Characters")
        ...
        self.html_chat_log.Bind(wx.html2.EVT_WEBVIEW_SCRIPT_MESSAGE_RECEIVED, self.OnScriptMessage)
        self.button_easteregg.Bind(wx.EVT_BUTTON, self.EasterEgg)
        self.emoji_keyboard.Bind(wx.EVT_BUTTON, self.OpenEmojis)
    ...
    def OpenSettings(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'OpenSettings' not implemented!")
        event.Skip()

    def ClearChat(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'ClearChat' not implemented!")
        event.Skip()

    def Fortunes(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'Fortunes' not implemented!")
        event.Skip()

    def OnScriptMessage(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'OnScriptMessage' not implemented!")
        event.Skip()

    def EasterEgg(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'EasterEgg' not implemented!")
        event.Skip()

    def OpenEmojis(self, event):  # wxGlade: MainWindow.<event_handler>
        print("Event handler 'OpenEmojis' not implemented!")
        event.Skip()

    def SendMessage(self, event):  # wxGlade: MainWindow.<event_handler>
    ...
    def OnResize(self, event):  # wxGlade: MainWindow.<event_handler>
